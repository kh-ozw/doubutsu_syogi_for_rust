...
fn main() {
    ...
    for board in board_list {
        ...
        print!(
            "node:{:>02}, p1:{}, p2:{} ",
            first_node_count, p1_hand_count, p2_hand_count
        );
        for i in 0..3 {
            let depth: i32 = DEPTH - i;
            // 探索
            let start = Instant::now();
            let best_node = nega_scout(&board, &board, is_player1, depth, -50000, 50000);
            ...
            let mark = if end.as_secs() > 60 { "x" } else { "o" };
            print!(
                "|{} {}: depth:{}, t:{:>03}s, {} ",
                i,
                mark,
