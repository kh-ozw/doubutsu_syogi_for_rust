...
fn main() {
            ...
            Ok(stream) => {
                ...
                loop {
                    ...
                    if buffer[6] == turn_buffer[14] {
                        ...
                        let depth = DEPTH;
                        let best_node: Node =
                            nega_scout(&board, &board, is_player1, depth, -50000, 50000);
                        ...
                        let point = judge(&next_board, &board, is_player1);
                        if point == WIN_POINT {
                            println!("you win!");
                            break;
    ...
    fn make_board(board_vec: &mut Vec<u8>) -> Bitboard::bitboard::Bitboard {
    ...
    fn make_moved_board(
        ...
        // プレイヤー2の場合
            ...
            if board.white_b & dst != 0 {
                ...
                board.white_b = board.white_b & !dst;
                // 持ち駒に追加
                board.black_b = (board.black_b + (1 << 12)) | board.black_b;
                if board.kb & dst != 0 {
                    // ライオンの盤面の駒を消し、取った駒を手持ちに加える
                    board.kb = (board.kb & !dst) + (1 << 12);
                } else if board.rb & dst != 0 {
    ...
    fn next_move_list(board: &Bitboard::bitboard::Bitboard, is_player1: bool) -> Vec<(i32, i32)> {
    ...
    fn get_board_name(i: i32) -> String {
        match i {
    ...
    fn print_move(move_vec: (i32, i32)) {
        println!("{:<024b}", move_vec.0);
        println!("{:<024b}", move_vec.1);
    }

    fn print_nega(depth: i32, point: i32, best_move: (i32, i32)) {
        if depth > 0 {
